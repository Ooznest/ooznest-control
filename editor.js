export class GCodeEditor {
    constructor(containerId, themeColors) {
        ...
        this.textarea.className = 'w-full h-full p-4 font-mono text-sm resize-none outline-none border-0 bg-transparent shadow-none';
        ...
        this.textarea.style.padding = '16px 24px';
