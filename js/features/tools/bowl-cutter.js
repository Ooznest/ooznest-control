export class BowlCutter {
    ...
    generate() {
        ...
        if (s.safeZ <= 0) {
            window.reporter.showAlert('Invalid Safe Z', 'Safe Z must be greater than 0.');
            return;
        }
